...
<div class="panel panel-default">
 <div class="panel-heading">
  <h3 class="panel-title">Volunteer sign up</h3>
 </div>
 ...
 <form method="post" action="" class="form-horizontal" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="name2"
       placeholder="Last Name" name="age">
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="name" class="col-sm-2 control-label">Flat No No.</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="name"
       placeholder="Flat No" name="flat_no" >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="name"
       placeholder="Building Name" name="building_name">
    </div>
  </div>
...
<div class="form-group">
    <label for="name" class="col-sm-2 control-label">Home No</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="name"
       placeholder="Home No" name="home_no">
    </div>
  </div>
 ...
 <div class="col-sm-6">
   <div class="input-group input-group-sm">
    <input type="email" class="form-control" placeholder="Email Id"  name="email_id" >
  </div>
  </div>
  </div>
